...
public class TypeToStringMirrorVisitor extends AbstractTypeVisitor14<StringBuilder, StringBuilder> {
	...
	static String toCodeSafeString(TypeMirror typeMirror, int depth, Map<TypeVariable, String> typeVariables) {
		var v = new TypeToStringMirrorVisitor(depth, typeVariables);
		v.typeVariables.putAll(typeVariables);
		StringBuilder b = new StringBuilder();
		return typeMirror.accept(v, b).toString();
	}

	private TypeToStringMirrorVisitor() {
		this(1, new HashMap<>());
	}

	private TypeToStringMirrorVisitor(int depth, Map<TypeVariable, String> typeVariables) {
		super();
	...
	TypeToStringMirrorVisitor child() {
		TypeToStringMirrorVisitor tmv = new TypeToStringMirrorVisitor(depth + 1, typeVariables);
		return tmv;
	}
